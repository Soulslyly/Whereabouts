# Whereabouts 1.0.2 Compatibility Matrix
...
- The exact installed 3.14.0.0 DLL currently exposes the complete framework/ImGui export surface used by 1.0.2. The validator derives that list from the shipped source and consumer header.
