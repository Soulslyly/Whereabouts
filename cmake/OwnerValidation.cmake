...
if(WHEREABOUTS_OWNER_VALIDATION)
    if(NOT DEFINED WHEREABOUTS_MENU_FRAMEWORK_DLL OR WHEREABOUTS_MENU_FRAMEWORK_DLL STREQUAL "")
        message(FATAL_ERROR "WHEREABOUTS_MENU_FRAMEWORK_DLL is required when WHEREABOUTS_OWNER_VALIDATION is ON")
    endif()
    if(NOT EXISTS "${WHEREABOUTS_MENU_FRAMEWORK_DLL}" OR IS_DIRECTORY "${WHEREABOUTS_MENU_FRAMEWORK_DLL}")
        message(FATAL_ERROR "WHEREABOUTS_MENU_FRAMEWORK_DLL must name the exact installed SMF or AMF DLL")
    endif()
    ...
    if(WHEREABOUTS_EXPERIMENTAL_VR)
        execute_process(
            COMMAND powershell -NoProfile -ExecutionPolicy Bypass
                ...
                -MenuFrameworkDll "${WHEREABOUTS_MENU_FRAMEWORK_DLL}"
        ...
        execute_process(
            COMMAND powershell -NoProfile -ExecutionPolicy Bypass
                ...
                -MenuFrameworkDll "${WHEREABOUTS_MENU_FRAMEWORK_DLL}"
                -ProjectRoot "${WHEREABOUTS_PROJECT_ROOT}"
            RESULT_VARIABLE WHEREABOUTS_MENU_FRAMEWORK_VALIDATION_RESULT
            OUTPUT_VARIABLE WHEREABOUTS_MENU_FRAMEWORK_VALIDATION_OUTPUT
            ERROR_VARIABLE WHEREABOUTS_MENU_FRAMEWORK_VALIDATION_ERROR
        )
        if(NOT WHEREABOUTS_MENU_FRAMEWORK_VALIDATION_RESULT EQUAL 0)
            message(FATAL_ERROR "Exact menu-framework binary validation failed:\n${WHEREABOUTS_MENU_FRAMEWORK_VALIDATION_OUTPUT}${WHEREABOUTS_MENU_FRAMEWORK_VALIDATION_ERROR}")
        endif()
