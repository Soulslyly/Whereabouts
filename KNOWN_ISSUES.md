...
There are currently no confirmed unresolved bugs listed for Whereabouts 1.0.2. The behaviors below are known limitations of Skyrim, external UI mods, or the information available to Whereabouts.
